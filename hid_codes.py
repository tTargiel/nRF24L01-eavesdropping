USB_HID_KEYS = {
    ...
    "0xe8": "KEY_MEDIA_PLAYPAUSE",  # Keyboard Play/Pause
    "0xe9": "KEY_MEDIA_STOPCD",  # Keyboard Stop/CD
    "0xea": "KEY_MEDIA_PREVIOUSSONG",  # Keyboard Previous Track
    "0xeb": "KEY_MEDIA_NEXTSONG",  # Keyboard Next
}
...
USB_HID_MODIFIERS = {
    "0x01": "KEY_MOD_LCTRL",  # Keyboard Left Control
    "0x02": "KEY_MOD_LSHIFT",  # Keyboard Left Shift
    "0x04": "KEY_MOD_LALT",  # Keyboard Left Alt
    "0x08": "KEY_MOD_LMETA",  # Keyboard Left GUI
    "0x10": "KEY_MOD_RCTRL",  # Keyboard Right Control
    "0x20": "KEY_MOD_RSHIFT",  # Keyboard Right Shift
    "0x40": "KEY_MOD_RALT",  # Keyboard Right Alt
    "0x80": "KEY_MOD_RMETA",  # Keyboard Right GUI
}

USB_HID_MODIFIERS_HUMAN = {
    "0x01": "CTRL",  # Keyboard Left Control
    "0x02": "SHIFT",  # Keyboard Left Shift
    "0x04": "ALT",  # Keyboard Left Alt
    "0x08": "META",  # Keyboard Left GUI
    "0x10": "CTRL",  # Keyboard Right Control
    "0x20": "SHIFT",  # Keyboard Right Shift
    "0x40": "ALT",  # Keyboard Right Alt
    "0x80": "META",  # Keyboard Right GUI
}
